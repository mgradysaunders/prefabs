...
// Periodic simplex noise.
typedef pre::periodic_noise_adapter2<
        pre::simplex_noise3<Float>> PeriodicSimplexNoise2;
...
int main(int argc, char** argv)
{
    ...
    std::string ofs_name = "periodic_simplex_noise2.pgm";
    ...
    << "Specify output filename. By default, periodic_simplex_noise2.pgm.\n";
