...
#include <preform/worley_noise3.hpp>
...
// Worley noise.
typedef pre::worley_noise3<Float> WorleyNoise3;
...
int main(int argc, char** argv)
{
    ...
    Float noise_locz = 0;
    std::string ofs_name = "worley_noise3.pgm";
    ...
    << "Specify output filename. By default, worley_noise3.pgm.\n";
